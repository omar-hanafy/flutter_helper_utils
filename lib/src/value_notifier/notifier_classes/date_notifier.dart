...
class DateTimeNotifier extends ValueNotifier<DateTime> implements DateTime {
  ...
  /// updates the current [ValueNotifier]s [DateTime] to Now and return it.
  ...
  ///
  /// ```dart
  /// final now = DateTime.now().notifier.notifier;
  ...
  ///
  /// ```dart
  /// final now = DateTime.now().notifier;
  ...
  /// ```dart
  /// final moonLanding = DateTime.utc(1969, 7, 20, 20, 18, 04).notifier;
  ...
  ///
  /// ```dart
  /// final today = DateTime.now().notifier;
  ...
  ///
  /// ```dart
  /// final berlinWallFell = DateTime.utc(1989, DateTime.november, 9).notifier;
  ...
  ///
  /// ```dart
  /// final berlinWallFell = DateTime(1989, DateTime.november, 9).notifier;
  ...
  ///
  /// ```dart
  /// final dDay = DateTime.utc(1944, 6, 6).notifier;
  /// print(dDay.isUtc); // true
  ///
  /// final local = DateTime(1944, 6, 6).notifier;
